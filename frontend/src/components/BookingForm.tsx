...
export function BookingForm({ isQuote = false, onClose }: BookingFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const emailSubject = isQuote ? 'Quote Request from MyUberLimos Website' : 'Booking Request from MyUberLimos Website';
    const emailBody = `
      Name: ${formData.name}
    ...
    setTimeout(() => {
      console.log('Email would be sent to info@myuberlimos.com.au with:');
